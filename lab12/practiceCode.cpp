...
int main() {
    ...
    G.setStudent(0,"hatim",240673);
    G.setStudent(1,"zaid",240500);
    G.setStudent(2,"fuzail",240699);
    G.setStudent(3,"Abdullah",240977);
    G.setStudent(4,"Seniya",240608);
    ...
    G.insertWeightedEdge(0,2,3);
    G.insertWeightedEdge(1,3,1);
    G.insertWeightedEdge(1,4,3);
